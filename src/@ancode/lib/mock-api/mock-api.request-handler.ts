...
import { AncodeMockApiReplyCallback } from '@ancode/lib/mock-api/mock-api.types';

export class AncodeMockApiHandler
{
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: AncodeMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: AncodeMockApiReplyCallback): void
    {
        // Store the reply
