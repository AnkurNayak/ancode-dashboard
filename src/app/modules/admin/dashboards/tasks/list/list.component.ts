...
import { AncodeNavigationService } from '@ancode/components/navigation';
...
import { Task, Tag } from 'app/modules/admin/dashboards/tasks/tasks.types';
...
export class TasksListComponent implements OnInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
            ...
            .subscribe((tasks: Task[]) => {
                ...
                setTimeout(() => {
                    ...
                    if ( mainNavigationComponent )
                    {
                        ...
                        const menuItem = this._ancodeNavigationService.getItem('apps.tasks', mainNavigation);
        ...
        this._ancodeMediaWatcherService.onMediaQueryChange$('(min-width: 1440px)')
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((state) => {
