...
export class AncodeMockApiInterceptor implements HttpInterceptor
{
    /**
     * Constructor
     */
    constructor(
        @Inject(ANCODE_MOCK_API_DEFAULT_DELAY) private _defaultDelay: number,
    ...
    intercept(request: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>>
    {
        ...
        const {
                  handler,
                  urlParams
              } = this._ancodeMockApiService.findHandler(request.method.toUpperCase(), request.url);
