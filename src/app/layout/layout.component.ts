...
import { ANCODE_VERSION } from "@ancode/version/ancode-version";
...
export class LayoutComponent implements OnInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        combineLatest([
            ...
            this._ancodeMediaWatcherService.onMediaQueryChange$(['(prefers-color-scheme: dark)', '(prefers-color-scheme: light)'])
        ]).pipe(
            ...
            map(([config, mql]) => {
                ...
                if ( config.scheme === 'auto' )
                {
                    ...
                    options.scheme = mql.breakpoints['(scheme: dark)'] ? 'dark' : 'light';
                }
        ...
        // Set the app version
        this._renderer2.setAttribute(this._document.querySelector('[ng-version]'), 'ancode-version', ANCODE_VERSION);
    }
