...
import { tags as tagsData, tasks as tasksData } from 'app/mock-api/dashboards/tasks/data';
import { AncodeMockApiService } from '@ancode/lib/mock-api/mock-api.service';
import { AncodeMockApiUtils } from '@ancode/lib/mock-api/mock-api.utils';
...
export class TasksMockApi
{
    ...
    registerHandlers(): void
    {
        ...
        this._ancodeMockApiService
            .onGet('api/dashboards/tasks/tags')
            .reply(() => [
                200,
        ...
        // -----------------------------------------------------------------------------------------------------
        this._ancodeMockApiService
            .onPost('api/dashboards/tasks/tag')
            .reply(({request}) => {
                ...
                // Generate a new GUID
                newTag.id = AncodeMockApiUtils.guid();
        ...
        // -----------------------------------------------------------------------------------------------------
        this._ancodeMockApiService
            .onPatch('api/dashboards/tasks/tag')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._ancodeMockApiService
            .onDelete('api/dashboards/tasks/tag')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._ancodeMockApiService
            .onGet('api/dashboards/tasks/all')
            .reply(() => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._ancodeMockApiService
            .onGet('api/dashboards/tasks/search')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._ancodeMockApiService
            .onPatch('api/dashboards/tasks/order')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._ancodeMockApiService
            .onGet('api/dashboards/tasks/task')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._ancodeMockApiService
            .onPost('api/dashboards/tasks/task')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._ancodeMockApiService
            .onPatch('api/dashboards/tasks/task')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._ancodeMockApiService
            .onDelete('api/dashboards/tasks/task')
            .reply(({request}) => {
