...
import { MailCategory, MailFilter, MailFolder, MailLabel, Mail } from 'app/modules/admin/dashboards/mailbox/mailbox.types';
...
export class MailboxService
{
    ...
    private _category: BehaviorSubject<MailCategory | any> = new BehaviorSubject(null);
    private _filters: BehaviorSubject<MailFilter[] | any> = new BehaviorSubject(null);
    private _folders: BehaviorSubject<MailFolder[] | any> = new BehaviorSubject(null);
    private _labels: BehaviorSubject<MailLabel[] | any> = new BehaviorSubject(null);
    private _mails: BehaviorSubject<Mail[] | any> = new BehaviorSubject(null);
    private _mailsLoading: BehaviorSubject<boolean | any> = new BehaviorSubject(false);
    private _mail: BehaviorSubject<Mail | any> = new BehaviorSubject(null);
    ...
    {
        return this._httpClient.get<MailFilter[]>('api/dashboards/mailbox/filters').pipe(
            tap((response: any) => {
    ...
    {
        return this._httpClient.get<MailFolder[]>('api/dashboards/mailbox/folders').pipe(
            tap((response: any) => {
    ...
    {
        return this._httpClient.get<MailLabel[]>('api/dashboards/mailbox/labels').pipe(
            tap((response: any) => {
    ...
    getMailsByFilter(filter: string, page: string = '1'): Observable<any>
    {
        ...
        return this._httpClient.get<Mail[]>('api/dashboards/mailbox/mails', {
            params: {
                filter,
                page
            }
    ...
    getMailById(id: string): Observable<any>
    {
        return this._mails.pipe(
            ...
            map((mails) => {
                ...
                // Find the mail
                const mail = mails.find((item: any) => item.id === id) || null;
    ...
    {
        return this._httpClient.patch('api/dashboards/mailbox/mail', {
            id,
            mail
        }).pipe(
            tap(() => {
    ...
    addLabel(label: MailLabel): Observable<any>
    {
        return this.labels$.pipe(
            take(1),
            switchMap(labels => this._httpClient.post<MailLabel>('api/dashboards/mailbox/label', {label}).pipe(
                map((newLabel) => {
    ...
    updateLabel(id: string, label: MailLabel): Observable<any>
    {
        return this.labels$.pipe(
            take(1),
            switchMap(labels => this._httpClient.patch<MailLabel>('api/dashboards/mailbox/label', {
                id,
                label
            }).pipe(
    ...
    deleteLabel(id: string): Observable<any>
    {
        return this.labels$.pipe(
            take(1),
            switchMap(labels => this._httpClient.delete('api/dashboards/mailbox/label', {params: {id}}).pipe(
                map((isDeleted: any) => {
