...
@Component({
    selector       : 'ancode-navigation-collapsable-item',
    templateUrl    : './collapsable.component.html',
    animations     : ancodeAnimations,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class AncodeNavigationCollapsableItemComponent implements OnInit, OnDestroy
{
    ...
    {
        return {
            'ancode-navigation-item-collapsed': this.isCollapsed,
            'ancode-navigation-item-expanded' : this.isExpanded
        };
    }
    ...
    ngOnInit(): void
    {
        ...
        this._ancodeNavigationComponent.onCollapsableItemCollapsed
        ...
        if ( this.autoCollapse )
        {
            this._ancodeNavigationComponent.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void
    {
        ...
        this._ancodeNavigationComponent.onCollapsableItemCollapsed.next(this.item);
    }
    ...
    expand(): void
    {
        ...
        // Execute the observable
        this._ancodeNavigationComponent.onCollapsableItemExpanded.next(this.item);
    }
     ...
     * @private
     */
    private _hasActiveChild(item: AncodeNavigationItem, currentUrl: string): boolean
    {
     ...
     * @private
     */
    private _isChildrenOf(parent: AncodeNavigationItem, item: AncodeNavigationItem): boolean
    {
