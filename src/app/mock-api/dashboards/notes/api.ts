...
import { labels as labelsData, notes as notesData } from 'app/mock-api/dashboards/notes/data';
import { AncodeMockApiService } from '@ancode/lib/mock-api/mock-api.service';
import { AncodeMockApiUtils } from '@ancode/lib/mock-api';
...
export class NotesMockApi
{
    ...
    registerHandlers(): void
    {
        ...
        this._ancodeMockApiService
            .onGet('api/dashboards/notes/labels')
            .reply(() => [
                200,
        ...
        // -----------------------------------------------------------------------------------------------------
        this._ancodeMockApiService
            .onPost('api/dashboards/notes/labels')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._ancodeMockApiService
            .onPatch('api/dashboards/notes/labels')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._ancodeMockApiService
            .onDelete('api/dashboards/notes/labels')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._ancodeMockApiService
            .onPost('api/dashboards/notes/tasks')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._ancodeMockApiService
            .onGet('api/dashboards/notes/all')
            .reply(() => {
        ...
        this._ancodeMockApiService
            ...
            .reply(({request}) => {
                ...
                // Add an id
                note.id = AncodeMockApiUtils.guid();
