...
import { filters as filtersData, folders as foldersData, labels as labelsData, mails as mailsData, settings as settingsData } from 'app/mock-api/dashboards/mailbox/data';
...
export class MailboxMockApi
{
    ...
    registerHandlers(): void
    {
        ...
        this._ancodeMockApiService
            .onGet('api/dashboards/mailbox/settings')
        ...
        // -----------------------------------------------------------------------------------------------------
        this._ancodeMockApiService
            .onPatch('api/dashboards/mailbox/settings')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._ancodeMockApiService
            .onGet('api/dashboards/mailbox/folders')
            .reply(() => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._ancodeMockApiService
            .onGet('api/dashboards/mailbox/filters')
        ...
        // -----------------------------------------------------------------------------------------------------
        this._ancodeMockApiService
            .onGet('api/dashboards/mailbox/labels')
        ...
        // -----------------------------------------------------------------------------------------------------
        this._ancodeMockApiService
            .onPost('api/dashboards/mailbox/label')
            .reply(({request}) => {
                ...
                // Generate an id
                label.id = AncodeMockApiUtils.guid();
        ...
        // -----------------------------------------------------------------------------------------------------
        this._ancodeMockApiService
            .onPatch('api/dashboards/mailbox/label')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._ancodeMockApiService
            .onDelete('api/dashboards/mailbox/label')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._ancodeMockApiService
            .onGet('api/dashboards/mailbox/mails', 625)
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._ancodeMockApiService
            .onGet('api/dashboards/mailbox/mail')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._ancodeMockApiService
            .onPatch('api/dashboards/mailbox/mail')
            .reply(({request}) => {
