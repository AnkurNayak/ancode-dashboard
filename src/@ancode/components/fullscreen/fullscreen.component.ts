...
import { FSDocument, FSDocumentElement } from '@ancode/components/fullscreen/fullscreen.types';

@Component({
    selector       : 'ancode-fullscreen',
    templateUrl    : './fullscreen.component.html',
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'ancodeFullscreen'
})
export class AncodeFullscreenComponent implements OnInit
{
    @Input()
