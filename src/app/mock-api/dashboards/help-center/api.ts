...
import { faqCategories as faqCategoriesData, faqs as faqsData, guideCategories as guideCategoriesData, guideContent as guideContentData, guides as guidesData } from 'app/mock-api/dashboards/help-center/data';
...
export class HelpCenterMockApi
{
    ...
    registerHandlers(): void
    {
        ...
        this._ancodeMockApiService
            .onGet('api/dashboards/help-center/faqs')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._ancodeMockApiService
            .onGet('api/dashboards/help-center/guides')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._ancodeMockApiService
            .onGet('api/dashboards/help-center/guide')
            .reply(({request}) => {
