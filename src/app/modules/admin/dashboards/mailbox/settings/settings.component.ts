...
import { labelColors, labelColorDefs } from 'app/modules/admin/dashboards/mailbox/mailbox.constants';
import { MailboxService } from 'app/modules/admin/dashboards/mailbox/mailbox.service';
import { MailLabel } from 'app/modules/admin/dashboards/mailbox/mailbox.types';
...
export class MailboxSettingsComponent implements OnInit
{
    ...
    deleteLabel(id: string): void
    {
        ...
        labelsFormArray.removeAt(labelsFormArray.value.findIndex((label: { id: string; }) => label.id === id));
