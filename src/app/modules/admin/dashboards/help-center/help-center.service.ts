...
import { FaqCategory, GuideCategory, Guide } from 'app/modules/admin/dashboards/help-center/help-center.type';
...
export class HelpCenterService
{
    ...
    {
        return this._httpClient.get<FaqCategory[]>('api/dashboards/help-center/faqs').pipe(
            tap((response: any) => {
    ...
    {
        return this._httpClient.get<FaqCategory[]>('api/dashboards/help-center/faqs', {
            params: {slug}
        }).pipe(
            tap((response: any) => {
                this._faqs.next(response);
    ...
    {
        return this._httpClient.get<GuideCategory[]>('api/dashboards/help-center/guides', {
            params: {limit}
        }).pipe(
            tap((response: any) => {
    ...
    {
        return this._httpClient.get<GuideCategory>('api/dashboards/help-center/guide', {
            params: {
                categorySlug,
                guideSlug
            }
